...
\jobentry{Feb 2009 -- Jul 2012}{Network Administrator}{\href{http://www.uar.net/en/}{UARNet ISP}}{On call assistance, network administration, minor web development.}{\tech{FreeBSD} \tech{Linux} \tech{iptables} \tech{Oracle SQL} \tech{PHP}}
