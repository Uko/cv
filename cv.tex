...
\section{Employment}
\jobentry{Dec 2017 -- ongoing}{Big Data Engineer {\small (+ Scrum Master)}}{\href{http://swisscom.ch}{Swisscom}}{Development of an ETL application, refactoring of a client-facing web app, maintenance of a CI/DC infrastructure. Reduced the deployment time from one human/day to a few minutes with minimum interactions.}{\tech{Scala} \tech{Spark} \tech{NodeJS} \tech{Solr} \tech{Jenkins} \tech{Cloud Foundry}}
...
\eduentry{2013 -- 2017}{University of Lugano \& University of Bern}{Ph.D. in Informatics}{Thesis topic: ``Quality-Aware Tooling''}
