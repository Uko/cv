...
\newtcbox{\toolbox}{nobeforeafter, box align=base, colframe=black, boxrule=0.1pt, arc=0mm, left=2pt, right=2pt, top=0pt, bottom=0pt, boxsep=0pt, before upper=\strut}
...
\vspace{1pt} Most of my project are available at my GitHub account \href{https://github.com/Uko}{[github.com/Uko]}

\nocite{*}

\section{\ifselectedpub Selected \fi Publications}

Besides academic publishing I have a codding blog: \href{http://code.yuriy.tymch.uk}{[code.yuriy.tymch.uk]}
