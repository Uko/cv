...
\section{Employment}
\jobentry{Dec 2017 -- ongoing}{Senior Big Data Engineer {\small (+ Scrum Master)}}{\href{http://swisscom.ch}{Swisscom}}{Development of an ETL application, a client-facing web app, maintenance of a CI/DC infrastructure. Assistance on various data sourcing and analysis projects. Refactoring of a few systems. Reduced the deployment time from one human/day to a few minutes with minimum interactions. Saved a few dying features and operational failures.}{\tech{Scala} \tech{Spark} \tech{NodeJS} \tech{Solr} \tech{SQL} \tech{Jenkins} \tech{Cloud Foundry} \tech{Python} \tech{Jupyter} \tpharo}
