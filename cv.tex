...
\newcommand*{\jobentry}[4]{
	\cventry{#1\vspace{-1\normalbaselineskip}}{}{#3 \textnormal{as {\itshape #2}}}{}{}{#4}\vspace{0.1\normalbaselineskip}
  }

\newcommand*{\eduentry}[4]{
	\cventry{#1\vspace{-1\normalbaselineskip}}{}{#3 \textnormal{@ {\itshape #2}}}{}{}{#4}\vspace{0.1\normalbaselineskip}
  }
...
\cvitem{\href{https://github.com/Uko/QualityAssistant}{QualityAssistant}}{My software-quality tool with a live feedback is integrated into the latest version of \href{http://pharo.org}{Pharo IDE}. Expected usage: 40 commercial companies, 30 universities (for teaching). }
%\cvitem{StackOverflow}{reputation}

\section{Employment}
\jobentry{Jan 2016 -- Present}{Research Assistant}{Universit{\"a}t Bern}{
Research on software quality and evolutionary monitoring. Maintenance if the group's git server. Invented a 3D visualization that allows detection of defects in software quality evolution.}
\jobentry{Oct 2013 -- Dec 2015}{Doctoral Assistant}{Universit\`a della Svizzera Italiana}{
...
\jobentry{Mar 2010 -- Aug 2012}{Founder/Leader}{Unikernel Team \textnormal{\emph{(freelance)}}}{Different websites made from scratch. Usually online shops, sometimes web apps with rich frontend.}
\jobentry{Feb 2009 -- Jul 2012}{System Administrator}{\href{http://www.uar.net/en/}{Ukrainian Academic Research Network}}{On call assistance, network administration, minor web development.}
